...
//            B buffer: 4-replica shared, compressed cache depth
//=============================================================================
...
// B shared buffer replica count (4 PE per replica, TDP dual-read)
`define B_REPLICAS    4
...
//=============================================================================
// PE Local Buffer Sizes (A: per-PE, independent; B: global shared)
//=============================================================================
`define A_ROW_SLOT_PER_PE  256
`define A_NNZ_SLOT_PER_PE  8192    // compressed: 16384 → 8192 (≈50% density)
`define A_ROW_ADDR_BITS    8       // log2(256)
`define A_NNZ_ADDR_BITS    13      // log2(8192)

`define B_ROW_SLOT         512
`define B_NNZ_SLOT         50000   // compressed: 78848 → 50000 (≈19% density)
`define B_ROW_ADDR_BITS    9       // log2(512)
`define B_NNZ_ADDR_BITS    16      // log2(50000)

...
set PYTHONPATH=d:\BaiduSyncdisk\PROJECT\SPGEMM-Accelerator-simple\test\mmap_sim

cd /d d:\BaiduSyncdisk\PROJECT\SPGEMM-Accelerator-simple\test\mmap_sim
...
echo.
echo ========================================
echo [2/2] Running mmap-DDR test...
echo ========================================

vvp -M "%COCOTB_LIB%" -m %COCOTB_VPI_MODULE% sim_build/sim_mmap.vvp

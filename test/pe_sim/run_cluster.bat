@echo off
REM Windows batch runner for 4-PE cluster simulation + Cocotb + Icarus Verilog.
REM Usage:
REM   run_cluster.bat
REM
REM Optional (edit inline or set before running):
REM   set MODULE=test_comp
REM   set TESTCASE=test_comp_case1_cluster
REM   set TOPLEVEL=tb_pe_cluster
...
set COCOTB_TESTCASE=
set COCOTB_TEST_FILTER=test_comp_case1_cluster
